...
This **tusb546** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **TUSB546** BSP USB-C component part.
...
Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/tusb546/blob/main/Release_Notes.html).
